...
#
# Created: Tue May 24 10:56:32 2016
...
class Ui_ContourDialog(object):
    def setupUi(self, ContourDialog):
        ...
        self.uUseGridLabel = QtGui.QLabel(self.groupBox_2)
        self.uUseGridLabel.setEnabled(True)
        self.uUseGridLabel.setObjectName(_fromUtf8("uUseGridLabel"))
        self.horizontalLayout_3.addWidget(self.uUseGridLabel)
        self.uUseGrid = QtGui.QCheckBox(self.groupBox_2)
        self.uUseGrid.setText(_fromUtf8(""))
        self.uUseGrid.setObjectName(_fromUtf8("uUseGrid"))
    ...
    def retranslateUi(self, ContourDialog):
        ...
        self.uUseGridLabel.setText(_translate("ContourDialog", "Use grid based contouring", None))
